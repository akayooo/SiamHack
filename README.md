...
- **Нестеров Никита** (БИВТ-23-1) — Машинное обучение (реализация алгоритма поиска монотонных участков и скрипта генерации признаков, писал классификаторы, ручная разметка). 
...
- **Савинов Святослав** (БИВТ-24-17) — Машинное обучение (реализация алгоритма поиска монотонных участков и скрипта генерации признаков, писал классификаторы, ручная разметка). 
...
- **Колокольцев Ярослав** (БПИ-23-2) — Дизайнер (делал презентацию и подсказывал, как подавать решение). 
