...
def main():
    ...
    cb_importances_recovery = model_recovery_cb.get_feature_importance()
    plt.figure(figsize=(10, 6))
    plt.barh(feature_names_recovery, cb_importances_recovery)
    plt.xlabel("Важность")
    plt.title("Feature Importance - Drop CatBoost")
    plt.show()

    # График для LightGBM (RECOVERY)
    lgb_importances_recovery = model_recovery_light.feature_importances_
    plt.figure(figsize=(10, 6))
    plt.barh(feature_names_recovery, lgb_importances_recovery)
    plt.xlabel("Важность")
    plt.title("Feature Importance - Recovery LightGBM")
    plt.show()
    ...
    # График для LightGBM (DROP)
    lgb_importances_drop = model_drop_light.feature_importances_
    plt.figure(figsize=(10, 6))
    plt.barh(feature_names_drop, lgb_importances_drop)
    plt.xlabel("Важность")
    plt.title("Feature Importance - Drop LightGBM")
    plt.show()
